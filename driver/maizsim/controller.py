...
""")
    ...
    def update_crop_output(self, weather, soil):
        self.crop_output.loc[len(self.crop_output)] = [
            ...
            self.plant.photosynthesis.sunlit_leaf_area_index,
            self.plant.photosynthesis.shaded_leaf_area_index,
            self.plant.photosynthesis.sunlit_irradiance,
            self.plant.photosynthesis.shaded_irradiance,
            self.plant.photosynthesis.sunlit.A_net,
            self.plant.photosynthesis.shaded.A_net,
            self.plant.photosynthesis.sunlit.A_gross,
            self.plant.photosynthesis.shaded.A_gross,
            self.plant.photosynthesis.sunlit.gs,
            self.plant.photosynthesis.shaded.gs,
